...
export const TRANSLATIONS = {
  en: {
    ...
    labelBlockThirdParty: "Block Third-Party Cookies",
    descBlockThirdParty: "Stop cross-site trackers from saving tracking cookies",
    labelCookieHardening: "Cookie Hardening (Theft Shield)",
    descCookieHardening: "Automatically enforce Secure and SameSite Lax attributes on login cookies to prevent hijacking",
    labelAutoAcceptCookies: "Auto-Dismiss Cookie Banners",
    descAutoAcceptCookies: "Automatically accept or hide GDPR/CCPA cookie consent banners on websites",
    statTrackersBlocked: "TRACKERS BLOCKED",
    statBandwidthSaved: "EST. DATA SAVED",
  ...
  tr: {
    ...
    labelBlockThirdParty: "Üçüncü Taraf Çerezlerini Engelle",
    descBlockThirdParty: "Siteler arası takipçi çerezlerin kaydedilmesini önle",
    labelCookieHardening: "Çerez Katılaştırma (Çalıntı Koruması)",
    descCookieHardening: "Çerez hırsızlığını ve oturum çalınmasını önlemek için giriş çerezlerine otomatik olarak Secure ve SameSite Lax özniteliklerini dayatır",
    labelAutoAcceptCookies: "Çerez Uyarılarını Otomatik Kapat",
    descAutoAcceptCookies: "Web sitelerindeki GDPR/CCPA çerez onay afişlerini otomatik olarak kabul eder veya gizler",
    statTrackersBlocked: "ENGELLENEN TAKİPÇİLER",
    statBandwidthSaved: "TAHMİNİ VERİ TASARRUFU",
